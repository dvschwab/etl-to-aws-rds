...
To secure the connection with SSL, first download the [AWS global certification bundle](https://truststore.pki.rds.amazonaws.com/global/global-bundle.pem). Save this in a convenient location and reference it with additional client options:
